...
def update():
    os.system("ifconfig wlan | grep RX\ packets | awk '{print $5}' > /tmp/rx")
    os.system("ifconfig wlan | grep TX\ packets | awk '{print $5}' > /tmp/tx")

def getnew():
    rx_new = get("ifconfig wlan | grep RX\ packets | awk '{print $5}'")
    tx_new = get("ifconfig wlan | grep TX\ packets | awk '{print $5}'")
